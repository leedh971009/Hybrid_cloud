        ...
        <div class="container">
            <div class="row">
              ...
              <%
					...
					String sql2 = "UPDATE films SET PRICE=14000 WHERE id=1;";
				       ...
				       <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="data/img/films/12.png">
					...
					String sql2 = "UPDATE films SET PRICE=16000 WHERE id=2;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/alien.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=16000 WHERE id=3;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/avatar.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=14000 WHERE id=4;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/Dune.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=15000 WHERE id=5;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/panda.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=15000 WHERE id=6;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/the_admiral.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=14000 WHERE id=7;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/the_roundup.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=16000 WHERE id=8;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/topgun.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
					...
					String sql2 = "UPDATE films SET PRICE=14000 WHERE id=9;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films/interstellar.jpg">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
