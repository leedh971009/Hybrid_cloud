            ...
            <div class="row">
              ...
              <%
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=1;";
				        rs1 = stmt1.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=7000 WHERE id=1;";
				       ...
				       <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/12.png">
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=2;";
				        rs2 = stmt2.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=8000 WHERE id=2;";
					updatestmt2 = conn2.prepareStatement(sql2);
						
					int rowsAffected = updatestmt2.executeUpdate();
				
				        // Display films item details
				        if (rs2.next()) {
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/alien2.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=3;";
				        rs3 = stmt3.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=8000 WHERE id=3;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/avatar.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=4;";
				        rs4 = stmt4.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=7000 WHERE id=4;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/Dune.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=5;";
				        rs5 = stmt5.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=7500 WHERE id=5;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/panda.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=6;";
				        rs6 = stmt6.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=7500 WHERE id=6;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/the_admiral.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=7;";
				        rs7 = stmt7.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=7000 WHERE id=7;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/the_roundup.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=8;";
				        rs8 = stmt8.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=8000 WHERE id=8;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/topgun.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
				    ...
				    try {
				        ...
				        String sql1 = "SELECT * FROM films WHERE id=9;";
				        rs9 = stmt9.executeQuery(sql1);

					String sql2 = "UPDATE films SET PRICE=7000 WHERE id=9;";
					...
					%>
				            ...
				            <div class="col-lg-4 col-md-6 col-sm-6">
				                <div class="product__item">
				                    <div class="product__item__pic set-bg" data-setbg="data/img/films_2/interstellar.png">
				                        <div class="ep"><%= price1 %>₩</div>
				                        <div class="comment"><i class="fa fa-comments"></i><%= COMMENT1 %></div>
				                        <div class="view"><i class="fa fa-eye"></i> <%= VIEW1 %></div>
				                    </div>
